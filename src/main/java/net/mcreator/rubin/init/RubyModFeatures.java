...
public class RubyModFeatures {
	...
	static {
		REGISTRY.put(ZhilarudyFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_STRUCTURES,
				ZhilarudyFeature.GENERATE_BIOMES, ZhilarudyFeature.CONFIGURED_FEATURE));
	}
