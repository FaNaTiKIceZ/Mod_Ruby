...
public class Rubin_armorSwordItem extends RubinModElements.ModElement {
	@ObjectHolder("rubin:rubin_armor_sword")
	public static final Item block = null;

	public Rubin_armorSwordItem(RubinModElements instance) {
		super(instance, 2);
	}
