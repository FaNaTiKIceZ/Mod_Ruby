...
public class RubinovyighladkiiblokBlock extends RubinModElements.ModElement {
	@ObjectHolder("rubin:rubinovyighladkiiblok")
	public static final Block block = null;

	public RubinovyighladkiiblokBlock(RubinModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rubinovyighladkiiblok");
		}
